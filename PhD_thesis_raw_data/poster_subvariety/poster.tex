...
$\;$\\[-30mm] $\,$
  ...
  \end{minipage}
  \end{figure}
Are these the only cases where $\gamma_Z$ fails to be generically injective, when $Z=C$ is a curve? When $n=2$, $\phi_C\!\!: C^{\sm} \longrightarrow \mathbb{P}^1$ typically fails to be generically injective.
