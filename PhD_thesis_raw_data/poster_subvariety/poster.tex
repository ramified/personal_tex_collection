...
$\gamma_Z^{(\aff)}: \Lambda_{Z} \longrightarrow T^{*}_{0}A,$ which is generically finite whenever $Z$ is of general type.
  ...
  $\;$\\[-48mm] $\,$
    ...
    \begin{minipage}[t]{.9\textwidth}
      \vspace{-1cm}
    	\centering
    	\includegraphics[height=20cm]{figures/3dTikZ/combi_of_conormal_tangent_map.pdf}
    \end{minipage}
    \end{figure}
$\;$\\[-35mm] $\,$
\begin{tcolorbox}[
...
The monodromy group $\Gal(\gamma_C)$ helps us to determine controls the Tannaka group of the perverse sheaf category generated by the IC sheaf on $C$; see \cite[Thm 2.1]{Kr22GaussI}.
