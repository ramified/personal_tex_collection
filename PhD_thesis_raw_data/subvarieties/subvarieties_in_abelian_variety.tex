...
\begin{remark}
For the most time the resulting curve $C \subset A$ is not invariant under any non-trivial translation of $A$, as the automorphism of $C'$ does not necessarily lift to an automorphism of $C$. Therefore, Example \ref{eg:bielliptic} serve as an example of Question \ref{ques:mon_gp_for_classical_Prym} and \ref{ques:monodromy_2}.
