...
\begin{equation*}
\begin{aligned}
  c_{M,l}\left(\Lambda_{Z^{(m)}}\right)=\;& \frac{1}{d_Z^{(m)}} \sum_{\lambda \dashv l} \;\widetilde{\mu}_{\widetilde{d}}^{\lambda} \left( \bigast_{i=1}^{k'} c_{\lambda_i}\right) \\
\end{aligned}
\end{equation*}
...
\renewcommand\labelenumi{(\theenumi)}
\begin{enumerate}[(1)]
\item For all $g\in \Gal(\gamma_{Z})$, we have $ Z^{g(m)}=Z^{(m)}$, $c_Z^{g(m)}=d_Z^{(m)}$;
...
\begin{equation*}
\begin{aligned}
  c_l\left(\Lambda_{Z^{(m)}}\right)=\;& \frac{1}{d_Z^{(m)}} \sum_{\lambda \dashv l} \;\mu_d^{\lambda} \left( \bigast_{i=1}^{k'} c_{\lambda_i}\right)\qquad && \text{type $A$ case} \\ 
  c_l\left(\Lambda_{Z^{(m)}}\right)=\;& \frac{1}{d_Z^{(m)}} \sum_{\lambda \dashv l} \;\widetilde{\mu}_{\widetilde{d}}^{\lambda} \left( \bigast_{i=1}^{k'} c_{\lambda_i}\right)\qquad && \text{type $C$ case} \\
\end{aligned}
\end{equation*}
