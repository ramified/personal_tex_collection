...
by successively selecting $v_i \in \Hnm_1(A;\mathbb{Z})$ outside the complex span $\left< v_1,\ldots,v_{i-1} \right>_{\mathbb{C}}$. Writing $E_i:= \mathbb{C}/(\mathbb{Z} \otimes \zeta_k \mathbb{Z})$, we have an isogeny
