...
\begin{aligned}
  W_C\cong\;& S_2^{\oplus d/2} \rtimes S_{d/2}  \\ 
   M_C\subseteqq\;& S_4^{\oplus d/4} \rtimes S_{d/4}  \\ 
\end{aligned}
\end{equation*}
...
\section{When is monodromy group small}\label{sec:mon_examples}
