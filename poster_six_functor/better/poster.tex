...
To determine whether a complex $\mathcal{F}$ is {\color{BrickRed}perverse} or an {\color{BrickBlue}IC sheaf}, one simply needs to complete {\color{BrickRed}Table 1}.
