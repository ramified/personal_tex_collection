...
This part is already posted on  \href{https://arxiv.org/abs/2206.00444}{arXiv}. It focuses on the affine paving of the quiver (partial) flag varieties. We use basic cohomological algebraic tools to construct the affine pavings by induction, and the problem finally reduces to combinatorics related to the Auslander--Reiten theory.
