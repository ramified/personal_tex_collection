...
For the definition of smooth/irreducible/admissible/Weil--Deligne representation, see \cite{zbMATH07686814} or (partially)\cite[\href{https://github.com/ramified/personal_handwritten_collection/raw/main/weeklyupdate/2022.04.17_preliminary_facts_of_reps_of_p-adic_groups.pdf}{22.04.17}]{weeklyupdate}.
...
In order to state global Langlands correspondence, we need adèle and idèle which collects all local information. A short introduction of adèle and idèle can be found in A.
...
\section{Adèlic Modular Forms on Quaternion Algebras}
