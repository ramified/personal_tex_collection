...
* &  &  \\[-2mm] &\ddots&\\[-1mm]&&*
\end{pmatrix}}} & \visible<9->{\!\!\rightsquigarrow\!\! & \begin{aligned}
  \GL_n(\kappa)/T
  =\;& \left\{ \kappa^n= W_1\!\oplus \cdots \oplus\! W_n \;\middle| \; \dim W_i\!=\!1  \right\} }
\end{aligned}
\end{array}
...
\vspace{-5mm}
  \begin{figure}[th]
  \visible<5->{\begin{minipage}[t]{.55\textwidth}
    \vspace{0pt}
  	\centering
  	\includegraphics[height=18mm]{figure/SL_2_apartment.png}
  \end{minipage}}
...
\vspace{-5mm}
  ...
  \begin{minipage}[t]{.55\textwidth}
    \vspace{0pt}
  	\centering
  	\visible<9->{\includegraphics[height=35mm]{figure/SL_3_apartment.png}}
  \end{minipage}
  \begin{minipage}[t]{.43\textwidth}
  $\,$\\[-4mm]
% https://q.uiver.app/#q=
...
\end{tikzcd}\]}
\vspace{-3mm}
\visible<8->{$$W=S_3=\left< s_1,s_2 \right>$$}
  \end{minipage}
  \end{figure}
\end{short}}
\end{frame}
...
$F$                                                  & local field               & \visible<2->{$\mathbb{Q}_p$}                     \\
...
\begin{short}
  \begin{figure}
    \centering
    \only<1>{\includegraphics[width=.45\linewidth]{figure/SL_3(F)_apartment_Weyl3.png}}
