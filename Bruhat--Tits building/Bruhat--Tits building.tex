...
\end{tikzcd}\]  	
  \end{minipage}
  $$\left\{ \text{ (Weyl) chambers } \right\} \quad\stackrel{1:1}{\longleftrightarrow}\quad W \quad\stackrel{1:1}{\longleftrightarrow}\quad  \left\{ B \;\middle|\; B \supset T_0  \right\}$$
...
\vspace{-5mm}
  ...
  \begin{minipage}[t]{.55\textwidth}
    \vspace{0pt}
  	\centering
  	\includegraphics[height=18mm]{figure/SL_2_apartment_Borel.png}
  \end{minipage}
  \begin{minipage}[t]{.43\textwidth}
  $\,$\\[-4mm]
\[\begin{tikzcd}[ampersand replacement=\&,column sep=5mm,row sep=-2mm]
...
\vspace{-5mm}
  ...
  \begin{minipage}[t]{.55\textwidth}
    \vspace{0pt}
  	\centering
  	\includegraphics[height=35mm]{figure/SL_3_apartment_Borel.png}
  \end{minipage}
  \begin{minipage}[t]{.43\textwidth}
  $\,$\\[-4mm]
% https://q.uiver.app/#q=
...
\vspace{-5mm}
  \begin{figure}
    \centering
    \includegraphics[width=\linewidth]{figure/SL_2(F)_apartment_Weyl.png}
  \end{figure}
\end{short}
\end{frame}
...
\vspace{-5mm}
  \begin{figure}
    \centering
    \includegraphics[width=.45\linewidth]{figure/SL_3(F)_apartment_Weyl2.png}
  \end{figure}
\end{short}
\end{frame}
...
\begin{aligned}
  ...
  \left\{ (I,T)\;\middle|\;I \supset T \right\} =\;& \left\{ (gI_0g^{-1},gT_0g^{-1}) \right\} &&\cong G/T_0\ignore{(\mathcal{O})}  
\end{aligned}
\end{equation*}
\end{short}
\vspace{-7mm}
...
\end{tikzcd}\]  	
  \end{minipage}
  $$\left\{ \text{ chambers } \right\} \quad\stackrel{1:1}{\longleftrightarrow}\quad W_{\ext} \quad\stackrel{1:1}{\longleftrightarrow}\quad  \left\{ I \;\middle|\; I \supset T_0  \right\}$$
\end{frame}
...
\vspace{-5mm}
  \begin{figure}
    \centering
    \includegraphics[width=\linewidth]{figure/SL_2(F)_apartment_Parahoric.png}
  \end{figure}
\end{short}
\end{frame}
...
\begin{short}
  \begin{figure}
    \centering
%    \includegraphics[width=.55\linewidth]{figure/SL_3(F)_apartment_Weyl3.png}
%    \includegraphics[width=.55\linewidth]{figure/SL_3(F)_apartment_Iwahori.png}
\includegraphics[width=.65\linewidth]{figure/SL_3(F)_apartment_parahoric.png}
  \end{figure}
\end{short}
\end{frame}
...
\end{theorem}
We call $\rho$ reductive when $\overline{\rho(\pi_1(M))}^{\Zar} \subseteq \GL_n(F)$ is reductive.
\end{frame}
